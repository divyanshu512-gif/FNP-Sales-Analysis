...
You have been given a dataset from FNP (Ferns and Petals) that specializes in sending gifts for various occasions like Diwali, Raksha bandhan, Holi, Valentine's Day, Birthdays and Anniversaries. The dataset contains details about the products, orders, customers
