...
**6**. Among the product categories here are top 5 product of FNP. Colors are the top most demanded product of FNP, it is increasing very exponationally. The second most demanded product of FNP is soft toys, it's demand is high in young generation. After soft toys, The third most demanded product is sweets because in india sweets are needed every house
